...
BICSEG_LOC=$1 # BICseqToTHetA_INPUT=$BICseq_DIR"/"$PREFIX".bicseg"
PREFIX=$2
THETA_OUTPUT_DIR=$3
READ_DEPTH_FILE_LOC=$4

THetA_PREFIX="$PREFIX/THetA.input"
...
echo "Running THetA..."
./../../PipelineSoftware/theta/bin/RunTHetA $THetA_INPUT -d $THETA_OUTPUT_DIR -p $PREFIX --READ_DEPTH_FILE $READ_DEPTH_FILE_LOC
#else
