...
GENE_TORRENT_BIN=$(pwd)/PipelineSoftware/CGHub/GeneTorrent-3.3.4-Ubuntu10.x86_64/usr/bin
GENE_TORRENT_CONFS=$(pwd)/PipelineSoftware/CGHub/GeneTorrent-3.3.4-Ubuntu10.x86_64/usr/share/GeneTorrent/
KEY_FILE=$(pwd)/PipelineSoftware/CGHub/keys/cghub.key
